module.exports = function(options, callback) {
  ...
  monkey_response.prototype.writeHead = function () {
    ...
    this.setHeader('Access-Control-Allow-Origin', '*'); // TODO: getAllowedCrossDomains()
    this.setHeader('Access-Control-Allow-Methods', 'GET,PUT,POST,DELETE'); // TODO: getAllowedCrossDomainMethods()
  ...
  server.get('/reports', function(req, res, next) {
    DAL.Reports.loadAll(function(error, reports) {
      res.send(reports);
    });
  });
